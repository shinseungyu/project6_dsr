    ...
    <div className="min-h-screen bg-[#f9fafb] text-gray-900 font-sans">
      ...
      <footer className="bg-white border-t border-gray-200 py-20 px-4 sm:px-6 lg:px-8 mt-12">
        <div className="max-w-4xl mx-auto space-y-16">
          <section>
            <h2 className="text-xl font-bold text-black mb-6">유용한 관련 사이트</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <a href="https://importtaxcalc.com" target="_blank" rel="noopener noreferrer" className="flex gap-4 items-start p-5 rounded-xl border border-gray-200 bg-gray-50 hover:border-blue-400 hover:bg-blue-50 transition-colors no-underline">
              ...
              <a href="https://www.nailstartup.com/" target="_blank" rel="noopener noreferrer" className="flex gap-4 items-start p-5 rounded-xl border border-gray-200 bg-gray-50 hover:border-blue-400 hover:bg-blue-50 transition-colors no-underline">
                <span className="text-3xl">💅</span>
                <div>
